...
class App {
    ...
    /**
         ...
         * @type {Http}
         */
    public static get HttpGET(): HTTP_GET {
        return HTTP_GET.getInstance();
    }
    public static get HttpRequestGet(): HttpRequestGet {
        return HttpRequestGet.getInstance();
    }
    public static get HttpRequestPost(): HttpRequestPost {
        return HttpRequestPost.getInstance();
    }
    ...
    public static Init():void {
        ...
        //App.HttpGET.initServer(App.GlobalData.HttpSerever);
        //App.HttpRequestGet.initServer(App.GlobalData.HttpSerever);
        //App.HttpRequestPost.initServer(App.GlobalData.HttpSerever);
        App.HttpRequest.initServer(App.GlobalData.HttpSerever);
